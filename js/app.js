...
var budgetController = (function() {
    ...
    return {
        addItem: function(type, des, val) {
            ...
            // Push it into our data structute
        ...
        calcultaeBudget: function() {
            // calculate total income and expenses

            calculateTotal('exp');
            calculateTotal('inc');

            // calculate the budget : icome - expeses
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var updateBudget = function() {
        ...
        //  1. Calculate the dubget
            budgetCtrl.calcultaeBudget();
        // 2. return the budget
        ...
        var updatePercentages = function() {
            ...
            // 2. Read oercentage from the budget
